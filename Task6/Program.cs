...
namespace MyVectorLib
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            int[] array2 = { 3, 4, 6, 9 };
            MyVector<int> vector = new MyVector<int>(array1);
            vector.Print();
            vector.AddAll(3, array2); //можем применить в этой строке любой из реализованных методов, например воспользуемся методом AddAll
            vector.Print();
